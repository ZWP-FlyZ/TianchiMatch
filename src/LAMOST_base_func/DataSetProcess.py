...
split_precent=[1300/442969.0, # star=6000 
               1200/5231.0, # galaxy=4700
               1000/1363.0, # qso=1220 * 3=3600
               1200/34288.0#unknown=1000
               ];
...
def run():
    ...
    random_merge(cut_target_set_out_paths,train_set_out_path);
        
    random_spliter(cut_left_set_out_paths[0],1000/442969.0,# 2000
                       star_test_tmp_path,None);# 
    random_spliter(cut_left_set_out_paths[3],1000/34288.0,# 1000
                       train_tmp_path,None);
 
                       
    random_spliter(cut_left_set_out_paths[1],1000/4000.0,# c从剩下的galaxy 中获取
                       train_tmp2_path,None);#    
